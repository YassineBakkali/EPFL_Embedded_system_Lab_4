	soc_system u0 (
		...
		.lcd_controller_0_conduit_end_res_n     (<connected-to-lcd_controller_0_conduit_end_res_n>),     //    lcd_controller_0_conduit_end.res_n
		.lcd_controller_0_conduit_end_csx       (<connected-to-lcd_controller_0_conduit_end_csx>),       //                                .csx
		.lcd_controller_0_conduit_end_wrx       (<connected-to-lcd_controller_0_conduit_end_wrx>),       //                                .wrx
		.lcd_controller_0_conduit_end_rdx       (<connected-to-lcd_controller_0_conduit_end_rdx>),       //                                .rdx
		.lcd_controller_0_conduit_end_d         (<connected-to-lcd_controller_0_conduit_end_d>),         //                                .d
		.lcd_controller_0_conduit_end_dcx       (<connected-to-lcd_controller_0_conduit_end_dcx>),       //                                .dcx
		.lcd_controller_0_conduit_end_lcd_on    (<connected-to-lcd_controller_0_conduit_end_lcd_on>),    //                                .lcd_on
		...
		.camera_controller_0_conduit_end_fval   (<connected-to-camera_controller_0_conduit_end_fval>),   //                                .fval
		.camera_controller_0_conduit_end_lval   (<connected-to-camera_controller_0_conduit_end_lval>),   //                                .lval
		.camera_controller_0_conduit_end_pxclk  (<connected-to-camera_controller_0_conduit_end_pxclk>),  //                                .pxclk
		.camera_controller_0_conduit_end_reset  (<connected-to-camera_controller_0_conduit_end_reset>),  //                                .reset
		.camera_controller_0_conduit_end_xclkin (<connected-to-camera_controller_0_conduit_end_xclkin>), //                                .xclkin

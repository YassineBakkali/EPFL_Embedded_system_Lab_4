...
# Sat Jan 01 21:31:23 CET 2022
# DO NOT MODIFY


# 
# camera_interface "camera_interface" v2.0
# Taras and Martin 2022.01.01.21:31:23
# This is a component that is made by real highly qualified HDL programmers.
# 
...
# 
set_module_property DESCRIPTION "This is a component that is made by real highly qualified HDL programmers."
set_module_property NAME camera_interface
set_module_property VERSION 2.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP Delachaux
set_module_property AUTHOR "Taras and Martin"
...
add_fileset_file Bayer_FIFO.cmp OTHER PATH ../hdl/Bayer_FIFO.cmp
add_fileset_file Bayer_FIFO.qip OTHER PATH ../hdl/Bayer_FIFO.qip
add_fileset_file Bayer_FIFO.vhd VHDL PATH ../hdl/Bayer_FIFO.vhd
add_fileset_file Buffer_FIFO.cmp OTHER PATH ../hdl/Buffer_FIFO.cmp
add_fileset_file Buffer_FIFO.qip OTHER PATH ../hdl/Buffer_FIFO.qip
...
add_interface_port conduit_end GPIO_1_D5M_D d5m_data Input 12
...
add_interface_port conduit_end GPIO_1_D5M_PIXCLK d5m_pxclk Input 1
add_interface_port conduit_end GPIO_1_D5M_RESET_N d5m_reset Output 1

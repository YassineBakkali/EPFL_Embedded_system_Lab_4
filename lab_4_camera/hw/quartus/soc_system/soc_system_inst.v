	soc_system u0 (
		.camera_interface_0_conduit_end_d5m_data                (<connected-to-camera_interface_0_conduit_end_d5m_data>),                //             camera_interface_0_conduit_end.d5m_data
		.camera_interface_0_conduit_end_d5m_fval                (<connected-to-camera_interface_0_conduit_end_d5m_fval>),                //                                           .d5m_fval
		.camera_interface_0_conduit_end_d5m_lval                (<connected-to-camera_interface_0_conduit_end_d5m_lval>),                //                                           .d5m_lval
		.camera_interface_0_conduit_end_d5m_pxclk               (<connected-to-camera_interface_0_conduit_end_d5m_pxclk>),               //                                           .d5m_pxclk
		.camera_interface_0_conduit_end_d5m_reset               (<connected-to-camera_interface_0_conduit_end_d5m_reset>),               //                                           .d5m_reset
		.camera_interface_0_conduit_end_d5m_xclkin              (<connected-to-camera_interface_0_conduit_end_d5m_xclkin>),              //                                           .d5m_xclkin
